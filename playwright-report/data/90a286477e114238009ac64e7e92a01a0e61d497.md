      ...
      - generic [ref=e9]:
        ...
        - generic [ref=e16]:
          ...
          - group [ref=e24]:
            ...
            - generic [ref=e30]:
              - progressbar
            - paragraph [ref=e31]: Ctrl+Enter 또는 Cmd+Enter로 빠르게 전송할 수 있습니다
          - button "프롬프트 개선하기" [disabled] [ref=e32]
        - paragraph [ref=e34]: 프롬프트를 입력하고 개선 버튼을 클릭하면 결과가 여기에 표시됩니다.
    - contentinfo [ref=e35]:
      - paragraph [ref=e37]: © 2025 Prompt Booster. AI로 더 나은 프롬프트를 만들어보세요.
